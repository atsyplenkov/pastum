 ...
 * @example
 * // R example
 * formatVariableName("Sales Q1", "r")     // Returns "Sales.Q1"
 * formatVariableName("2023 Revenue", "r") // Returns "x.2023.Revenue"
 * 
 * // Python example
 * formatVariableName("Sales Q1", "python")     // Returns "sales_q1"
 * formatVariableName("2023 Revenue", "python") // Returns "_2023_revenue"
 */
 ...
 * 
 * @example
 * convertValue("1,234.56")  // Returns 1234.56 (number)
 * convertValue("abc")       // Returns "abc" (string)
 */
 ...
 * 
 * @example
 * isNumeric("1,234.56")  // Returns true
 * isNumeric("-123.45")   // Returns true
 * isNumeric("01234")     // Returns false
 ...
 * 
 * @example
 * cleanDataValue("  Hello\u00A0World  ") // Returns "Hello World"
 */
 ...
 * 
 * @example
 * isRowEmpty(["", " ", "\t"])  // Returns true
 * isRowEmpty(["data", "", ""]) // Returns false
 */
